# Generated by Django 3.2.9 on 2022-05-01 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='problem.problemtag')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='problem',
            name='tags',
            field=models.ManyToManyField(through='problem.ProblemTagShip', to='problem.ProblemTag'),
        ),
